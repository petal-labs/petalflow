...
// This interface is used by the runtime to detect merge nodes without creating
// import cycles between the runtime and nodes packages.
type MergeCapable interface {
	Node
	// IsMergeNode returns true to identify this as a merge node.
	IsMergeNode() bool
