...
func (g *BasicGraph) Nodes() []core.Node {
	nodes := make([]core.Node, 0, len(g.nodeOrder))
...
// NodeByID retrieves a node by its ID.
func (g *BasicGraph) NodeByID(id string) (core.Node, bool) {
	node, ok := g.nodes[id]
	return node, ok
}
...
func (g *BasicGraph) AddNode(node core.Node) error {
	if node == nil {
