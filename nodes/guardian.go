...
func NewGuardianNode(id string, config GuardianNodeConfig) *GuardianNode {
	...
	return &GuardianNode{
		BaseNode: core.NewBaseNode(id, core.NodeKindGuardian),
		config:   config,
	}
}
...
func (n *GuardianNode) Run(ctx context.Context, env *core.Envelope) (*core.Envelope, error) {
	result := env.Clone()
...
func (n *GuardianNode) runCheck(ctx context.Context, check GuardianCheck, input any, env *core.Envelope) ([]GuardianFailure, error) {
...
func (n *GuardianNode) checkCustom(ctx context.Context, check GuardianCheck, value any, env *core.Envelope) ([]GuardianFailure, error) {
...
var _ core.Node = (*GuardianNode)(nil)
