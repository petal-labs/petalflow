...
func NewGateNode(id string, config GateNodeConfig) *GateNode {
	...
	return &GateNode{
		BaseNode: core.NewBaseNode(id, core.NodeKindGate),
		config:   config,
	}
}
...
func (n *GateNode) Run(ctx context.Context, env *core.Envelope) (*core.Envelope, error) {
	// Evaluate condition
...
func (n *GateNode) evaluateCondition(ctx context.Context, env *core.Envelope) (bool, error) {
