...
func NewHumanNode(id string, config HumanNodeConfig) *HumanNode {
	...
	return &HumanNode{
		BaseNode: core.NewBaseNode(id, core.NodeKindHuman),
		config:   config,
	}
}
...
func (n *HumanNode) Run(ctx context.Context, env *core.Envelope) (*core.Envelope, error) {
	// Check context
...
func (n *HumanNode) buildPrompt(env *core.Envelope) (string, error) {
...
func (n *HumanNode) buildRequestData(env *core.Envelope) map[string]any {
...
func (n *HumanNode) handleTimeout(env *core.Envelope, req *HumanRequest) (*core.Envelope, error) {
