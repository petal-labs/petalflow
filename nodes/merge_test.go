...
func TestNewMergeNode(t *testing.T) {
	...
	if node.Kind() != core.NodeKindMerge {
		t.Errorf("expected kind %q, got %q", core.NodeKindMerge, node.Kind())
	}
}
...
func TestMergeNode_MergeInputs_Empty(t *testing.T) {
	...
	result, err := node.MergeInputs(context.Background(), []*core.Envelope{})
...
func TestJSONMergeStrategy_Merge_EmptyInputs(t *testing.T) {
	...
	result, err := s.Merge(context.Background(), []*core.Envelope{})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if result == nil {
...
func TestJSONMergeStrategy_Merge_DisjointVars(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("a", 1)
	env2 := core.NewEnvelope().WithVar("b", 2)
	env3 := core.NewEnvelope().WithVar("c", 3)

	result, err := s.Merge(context.Background(), []*core.Envelope{env1, env2, env3})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestJSONMergeStrategy_Merge_OverwriteConflict_LastWins(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("key", "first")
	env2 := core.NewEnvelope().WithVar("key", "second")
	env3 := core.NewEnvelope().WithVar("key", "third")
...
func TestJSONMergeStrategy_Merge_OverwriteConflict_FirstWins(t *testing.T) {
	...
	result, err := s.Merge(context.Background(), []*core.Envelope{env1, env2})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestJSONMergeStrategy_Merge_ConflictError(t *testing.T) {
	...
	_, err := s.Merge(context.Background(), []*core.Envelope{env1, env2})
	if err == nil {
...
func TestJSONMergeStrategy_Merge_DeepMerge(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("config", map[string]any{
		"host": "localhost",
		"port": 8080,
	})
	env2 := core.NewEnvelope().WithVar("config", map[string]any{
		"port":    9090,
		"timeout": 30,
	})
...
func TestJSONMergeStrategy_Merge_MergesArtifacts(t *testing.T) {
	...
	env1 := core.NewEnvelope()
	env1.AppendArtifact(core.Artifact{ID: "a1", Type: "doc"})

	env2 := core.NewEnvelope()
	env2.AppendArtifact(core.Artifact{ID: "a2", Type: "doc"})
...
func TestJSONMergeStrategy_Merge_MergesMessages(t *testing.T) {
	...
	env1 := core.NewEnvelope()
	env1.AppendMessage(core.Message{Role: "user", Content: "Hello"})

	env2 := core.NewEnvelope()
	env2.AppendMessage(core.Message{Role: "assistant", Content: "Hi"})
...
func TestJSONMergeStrategy_Merge_VarsOnly(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("a", 1)
	env1.AppendArtifact(core.Artifact{ID: "a1"})

	env2 := core.NewEnvelope().WithVar("b", 2)
	env2.AppendArtifact(core.Artifact{ID: "a2"})
...
func TestConcatMergeStrategy_Merge_Basic(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("result", "Line 1")
	env2 := core.NewEnvelope().WithVar("result", "Line 2")
	env3 := core.NewEnvelope().WithVar("result", "Line 3")
...
func TestConcatMergeStrategy_Merge_CustomSeparator(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("items", "apple")
	env2 := core.NewEnvelope().WithVar("items", "banana")
	env3 := core.NewEnvelope().WithVar("items", "cherry")
...
func TestConcatMergeStrategy_Merge_DifferentOutputKey(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("source", "A")
	env2 := core.NewEnvelope().WithVar("source", "B")
...
func TestConcatMergeStrategy_Merge_MissingVar(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("text", "A")
	env2 := core.NewEnvelope() // Missing "text" var
	env3 := core.NewEnvelope().WithVar("text", "C")
...
func TestConcatMergeStrategy_Merge_NonStringValue(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("value", 42)
	env2 := core.NewEnvelope().WithVar("value", "text")
	env3 := core.NewEnvelope().WithVar("value", true)
...
func TestBestScoreMergeStrategy_Merge_HigherIsBetter(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("score", 0.7).WithVar("model", "A")
	env2 := core.NewEnvelope().WithVar("score", 0.9).WithVar("model", "B")
	env3 := core.NewEnvelope().WithVar("score", 0.5).WithVar("model", "C")
...
func TestBestScoreMergeStrategy_Merge_LowerIsBetter(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("latency", 100).WithVar("provider", "A")
	env2 := core.NewEnvelope().WithVar("latency", 50).WithVar("provider", "B")
	env3 := core.NewEnvelope().WithVar("latency", 150).WithVar("provider", "C")
...
func TestBestScoreMergeStrategy_Merge_NoScores(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("data", "A")
	env2 := core.NewEnvelope().WithVar("data", "B")
...
func TestBestScoreMergeStrategy_Merge_IntScores(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("priority", 1).WithVar("name", "low")
	env2 := core.NewEnvelope().WithVar("priority", 3).WithVar("name", "high")
...
func TestFuncMergeStrategy_Merge_CustomFunction(t *testing.T) {
	s := NewFuncMergeStrategy("sum_values", func(ctx context.Context, inputs []*core.Envelope) (*core.Envelope, error) {
		result := core.NewEnvelope()
		sum := 0
	...
	env1 := core.NewEnvelope().WithVar("value", 10)
	env2 := core.NewEnvelope().WithVar("value", 20)
	env3 := core.NewEnvelope().WithVar("value", 30)
...
func TestFuncMergeStrategy_Merge_NilFunction(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("key", "value")
	env2 := core.NewEnvelope().WithVar("other", "data")
...
func TestFuncMergeStrategy_Merge_Error(t *testing.T) {
	s := NewFuncMergeStrategy("failing", func(ctx context.Context, inputs []*core.Envelope) (*core.Envelope, error) {
		return nil, errors.New("merge failed")
	})

	env1 := core.NewEnvelope()
	_, err := s.Merge(context.Background(), []*core.Envelope{env1})
...
func TestAllMergeStrategy_Merge_CollectsAllVars(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("a", 1).WithVar("b", 2)
	env2 := core.NewEnvelope().WithVar("c", 3).WithVar("d", 4)
...
func TestAllMergeStrategy_Merge_CollectsSpecificVars(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("score", 0.9).WithVar("other", "ignored")
	env2 := core.NewEnvelope().WithVar("score", 0.7).WithVar("other", "also_ignored")
...
func TestAllMergeStrategy_Merge_UsesInnerStrategy(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("text", "A")
	env2 := core.NewEnvelope().WithVar("text", "B")
...
func TestMergeNode_MergeInputs_WithJSONStrategy(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("a", 1).WithVar("shared", "first")
	env2 := core.NewEnvelope().WithVar("b", 2).WithVar("shared", "second")

	result, err := node.MergeInputs(context.Background(), []*core.Envelope{env1, env2})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestMergeNode_MergeInputs_WithConcatStrategy(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("response", "Hello")
	env2 := core.NewEnvelope().WithVar("response", "World")
...
func TestMergeNode_MergeInputs_WithBestScoreStrategy(t *testing.T) {
	...
	env1 := core.NewEnvelope().WithVar("confidence", 0.6).WithVar("answer", "Maybe")
	env2 := core.NewEnvelope().WithVar("confidence", 0.95).WithVar("answer", "Yes")
	env3 := core.NewEnvelope().WithVar("confidence", 0.3).WithVar("answer", "No")

	result, err := node.MergeInputs(context.Background(), []*core.Envelope{env1, env2, env3})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
