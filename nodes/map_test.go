...
func TestNewMapNode(t *testing.T) {
	t.Run("defaults", func(t *testing.T) {
		...
		if node.Kind() != core.NodeKindMap {
			t.Errorf("expected kind %v, got %v", core.NodeKindMap, node.Kind())
		}
...
type testMapperNode struct {
	core.BaseNode
	id        string
	transform func(*core.Envelope) *core.Envelope
}
...
func (n *testMapperNode) Kind() core.NodeKind {
	return core.NodeKindNoop
}

func (n *testMapperNode) Run(ctx context.Context, env *core.Envelope) (*core.Envelope, error) {
